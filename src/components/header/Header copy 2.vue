<template>
    <header class="bg-gradient-to-r from-slate-900 via-gray-800 to-gray-900 border-b border-gray-700">
      ...
      <div class="px-4 py-2">
        <div class="flex flex-col">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
              ...
              <div class="relative" @click.stop="toggleUserMenu">
                ...
                <!-- Dropdown Menu - HII NIMEBAKI ILI UWEZE KU-ACCESS ACCOUNT SETTINGS -->
                <transition 
          ...
          <div class="relative mt-2">
            ...
            <div class="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-gray-900 to-transparent pointer-events-none"></div>
            <div class="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-gray-900 to-transparent pointer-events-none"></div>
          </div>
        </div>
      </div>
  
      <!-- NIMEONDOA KABISA MOBILE COLLAPSE MENU (ILE YA SLIDE KUTOKA JUU) -->
    </header>
  </template>
