<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-purple-500 to-blue-500 px-4 relative overflow-hidden">
      ...
      <div class="relative z-10 w-full max-w-md animate-slideUp">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-3xl">
          ...
          <div class="relative bg-gradient-to-r from-purple-600 to-blue-500 px-8 pt-8 pb-12">
            ...
            <div class="relative z-10 text-center">
              ...
              <p class="text-purple-100">Don't worry, we'll help you reset it</p>
            </div>
            <!-- Wave SVG -->
          ...
          <div class="px-8 py-8">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input 
                    ...
                    class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:outline-none transition-all duration-200"
            ...
            <div v-if="currentStep === 3" class="text-center space-y-5 animate-scaleIn">
              <div class="inline-flex items-center justify-center w-24 h-24 bg-green-100 rounded-full mx-auto">
                <svg class="w-12 h-12 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
              </div>
              <h3 class="text-2xl font-bold text-gray-800">Password Reset Successfully!</h3>
              <p class="text-gray-500">Your password has been reset. You can now login with your new password.</p>
              <button 
                @click="goToLogin"
                class="w-full bg-gradient-to-r from-purple-600 to-blue-500 text-white font-semibold py-3 rounded-xl transition-all duration-200 hover:shadow-lg"
              >
                Go to Login
              </button>
            </div>
